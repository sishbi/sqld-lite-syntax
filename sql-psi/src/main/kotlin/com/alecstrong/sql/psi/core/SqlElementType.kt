...
abstract class SqlSchemaContributorElementType<SchemaType : SchemaContributor>(
  ...
  override fun indexStub(stub: SchemaContributorStub, sink: IndexSink) {
    ...
    // The kind of statement is what building a schema asks for, and it cannot answer "which
    // statement declares this name". The second occurrence can. See
    // [SchemaContributorIndex.nameKey] for why one index holds both.
    sink.occurrence(SchemaContributorIndex.KEY, SchemaContributorIndex.nameKey(stub.name()))
  }
