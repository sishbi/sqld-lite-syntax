...
open class SqlCoreEnvironment(sourceFolders: List<Path>, dependencies: List<Path>) : AutoCloseable {
  ...
  init {
    ...
    projectEnvironment.project.registerService(
      ...
      // The coroutine scope is a 252 addition. Upstream builds against 233, where the constructor
      // takes the project alone.
      WorkspaceFileIndexImpl(projectEnvironment.project, coroutineScope),
    )
    projectEnvironment.project.registerService(
