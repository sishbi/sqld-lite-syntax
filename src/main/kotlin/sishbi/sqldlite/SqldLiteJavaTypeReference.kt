 ...
 */
class SqldLiteJavaTypeReference(javaType: SqldLiteJavaTypeMixin) :
    PsiReferenceBase<SqldLiteJavaTypeMixin>(javaType, TextRange(0, javaType.textLength)) {
    ...
    private fun qualify(name: String): String? =
        PsiTreeUtil
            .findChildrenOfType(element.containingFile, SqldLiteImportStmt::class.java)
